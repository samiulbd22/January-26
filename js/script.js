...
//Continue for mass calculating {"04/08/25-Cash":4550}    
    "01922362569":{
        ...
        payment             :{"11/01/26-Cash":2000,"19/01/26-Cash":500,"23/01/26-DBBL":1000,"30/01/26-DBBL":1000},
        // running month
        stay_cost       :2000,
        garage_cost     :0,
    ...
    "01797816501":{
        ...
        post_payable        :3087,
        previous_paid       :5000,
        previous_dining_cost:1620,
        payment             :{"01/01/26-Cash":3500,"19/01/26-Cash":1000,"26/01/26-Cash":500},
    ...
    "01581515641":{//01644377150
        ...
        post_payable        :5558,
        previous_paid       :7500,
        previous_dining_cost:2436,
        payment             :{"16/01/26-Bkash":3000,"27/01/26-Cash":3000},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
    ...
    "01537664564":{
        ...
        post_payable        :3828,
        previous_paid       :6200,
        previous_dining_cost:2695,
        payment             :{"06/01/26-Cash":2500,"13/01/26-Cash":4000},
        // running month
        stay_cost       :3000,
        garage_cost     :0,
    ...
    "01909752631":{
        ...
        payment             :{"08/01/26-Cash":4000,"17/01/26-Cash":500,"23/01/26-Cash":500},
        // running month
        stay_cost       :2800,
        garage_cost     :0,
        running_payable :3559,
        running_paid    :5000,
        running_meal    :28,
        // method calling
        preMonth,
    ...
    "01934147404":{
        ...
        previous_paid       :5900,
        previous_dining_cost:1450,
        payment             :{"11/01/26-Cash":3500,"24/01/26-Cash":2000,"29/01/26-Cash":500},
        // running month
        stay_cost       :3500,
        garage_cost     :0,
	...
	"01639523533":{
        ...
        post_payable        :4241,
        previous_paid       :6500,
        previous_dining_cost:1508,
        payment             :{"11/01/26-Cash":4000,"19/01/26-Cash":500},
    ...
    "01920056090":{
        ...
        post_payable        :3138,
        previous_paid       :6000,
        previous_dining_cost:2100,
        payment             :undefined,
        // running month
        stay_cost       :2400,
        garage_cost     :0,
        running_payable :2390,
        running_paid    :2000,
        running_meal    :25,
        // method calling
        preMonth,
...
//runningMonthPayment
    if(memberNumber.length === 11){
        if( memberNumber === "01639523533" 
         ...
         ||memberNumber==="01920056090" || memberNumber === "01821245430"||
            ...
            memberDiningList.innerHTML = `
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                <td>${members["01920056090"].name}</td>
                                                <td>${members["01920056090"].runningDiningCost()}</td>
                                                <td>${members["01920056090"].runningMonth().diningAdd}</td>
                                                <td class="getMeals">${members["01920056090"].runningMonth().remainDining}</td>
                                                <td>${members["01920056090"].runningMonth().diningDue}</td>
                                            </tr>
					                        <tr>
            ...
            if(memberNumber === '01710430501'){
                ...
                costTotalCheck.innerHTML = `<tr>
                                            ...
                                            <tr>
                                                <th>${members["01920056090"].name}</th>
                                                <td class="payable">${members["01920056090"].totalPayable()}</td>
                                                <td class="paid-me">${members["01920056090"].running_paid}</td>
                                                <td class="dining-me">${members["01920056090"].runningDiningCost()}</td>
                                                <td class="due-me">${members["01920056090"].runningMonth().diningDue}</td>
                                            </tr>
                                            <tr>
